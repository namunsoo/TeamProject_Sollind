					...
					<c:if test="${companyReviews != null }">
						<table id="companyShowReview">
							<tr>
								...
								<td align="center">
									<div class="companyShowReviewTitle">${cr.cr_title }</div>
								</td>
							</tr>
							<tr>
					...
					<table class="companyBoardTable">
						...
						<tr>
	       					<td class="companyBoardTitle" align="left">
	       						<c:choose>
	       							<c:when test="${fn:length(cb.b_title) > 10 }">
			       						<a href="goBoardDetail?b_no=${cb.b_no }">${fn:substring(cb.b_title,0,10) } ...</a>&nbsp;
	       							</c:when>
	       							<c:otherwise>
	       				...
	       				<tr>
	       					<td class="box2 companyBoardTxt" align="left" valign="middle">
